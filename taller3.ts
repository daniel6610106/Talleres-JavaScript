...
let miPromesa: Promise<string> = new Promise((resolve) => {
...
let miPromesa1: Promise<string> = new Promise((resolve, reject) => {
...
let estrato: number = 3;  // Cambia el valor de estrato para probar diferentes escenarios

let verificarSubsidio: Promise<string> = new Promise((resolve, reject) => {
...
let miPromesa2: Promise<number> = new Promise((resolve) => {
...
let promesa11: Promise<string> = new Promise((resolve) => {
    resolve("Somos ADSI");
});

// Promesa 2: Puede resolverse o rechazarse dependiendo de una condición (por ejemplo, una variable 'estado')
let estado: boolean = true;  // Cambia este valor a false para que la promesa se rechace

let promesa21: Promise<string> = new Promise((resolve, reject) => {
    if (estado) {
...
let promesa31: Promise<string> = new Promise((resolve) => {
...
let promesaAsincrona: Promise<string> = new Promise((resolve, reject) => {
...
let promesa1: Promise<string> = new Promise((resolve) => {
    setTimeout(() => {
...
let promesa2: Promise<string> = new Promise((resolve, reject) => {
    setTimeout(() => {
...
let promesa3: Promise<string> = new Promise((resolve) => {
    setTimeout(() => {
...
let promesa4: Promise<string> = new Promise((resolve) => {
    setTimeout(() => {
